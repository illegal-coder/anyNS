...
func TestStoreListFilteredAppliesFiltersBeforeLimit(t *testing.T) {
	store := NewStore(10)
	store.Append(Event{TraceID: "one", ClientIP: "192.0.2.10", ClientView: "default", Tenant: "default", QName: "one.hns.", QType: "A", RCode: "NOERROR", SourcePlugin: "hns", RiskLevel: "none", Action: "allow"})
	store.Append(Event{TraceID: "two", ClientIP: "192.0.2.11", ClientView: "default", Tenant: "default", QName: "two.hns.", QType: "AAAA", RCode: "SERVFAIL", SourcePlugin: "security", RiskLevel: "high", Action: "block", MatchedRule: "dga-high-entropy"})
	store.Append(Event{TraceID: "three", ClientIP: "192.0.2.12", ClientView: "default", Tenant: "default", QName: "three.hns.", QType: "A", RCode: "NXDOMAIN", SourcePlugin: "hns", RiskLevel: "low", Action: "allow"})
	store.Append(Event{TraceID: "four", ClientIP: "192.0.2.11", ClientView: "adguard", Tenant: "prod", QName: "four.hns.", QType: "TXT", RCode: "SERVFAIL", SourcePlugin: "security", RiskLevel: "high", Action: "block", MatchedRule: "dns-tunnel-high-entropy"})
