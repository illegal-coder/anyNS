...
tools 'curl -fsS -H "'"$AUTH_HEADER"'" "http://anyns-plugin-runtime:8081/api/v1/audit/events?source_plugin=namecoin-bit&limit=2&order=asc" | tee /tmp/runtime-namecoin-audit-order-asc.json'
...
tools 'curl -fsS -H "'"$AUTH_HEADER"'" "http://anyns-plugin-runtime:8081/api/v1/audit/events?source_plugin=namecoin-bit&limit=2&order=desc" | tee /tmp/runtime-namecoin-audit-order-desc.json'
...
tools 'curl -fsS -H "'"$AUTH_HEADER"'" "http://anyns-plugin-runtime:8081/api/v1/audit/events?source_plugin=namecoin-bit&limit=1&order=asc&page=true" | tee /tmp/runtime-namecoin-audit-page-1.json'
...
tools 'curl -fsS -H "'"$AUTH_HEADER"'" "http://anyns-plugin-runtime:8081/api/v1/audit/events?source_plugin=namecoin-bit&limit=1&order=asc&cursor=1" | tee /tmp/runtime-namecoin-audit-page-2.json'
