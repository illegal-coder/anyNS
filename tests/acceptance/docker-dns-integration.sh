...
tools 'grep -q "\"name\":\"solana-sns\"" /tmp/admin-plugins.json'
...
tools 'curl -fsS -H "'"$AUTH_HEADER"'" "http://anyns-admin-api:8080/api/v1/audit/events?source_plugin=management&limit=2&order=asc" | tee /tmp/admin-audit-order-asc.json'
tools 'grep -o "\"matched_rule\":\"[^\"]*\"" /tmp/admin-audit-order-asc.json | sed -n "1p" | grep -q "\"matched_rule\":\"policy.reload\""'
tools 'grep -o "\"matched_rule\":\"[^\"]*\"" /tmp/admin-audit-order-asc.json | sed -n "2p" | grep -q "\"matched_rule\":\"cache.flush\""'
tools 'curl -fsS -H "'"$AUTH_HEADER"'" "http://anyns-admin-api:8080/api/v1/audit/events?source_plugin=management&limit=2&order=desc" | tee /tmp/admin-audit-order-desc.json'
tools 'grep -o "\"matched_rule\":\"[^\"]*\"" /tmp/admin-audit-order-desc.json | sed -n "1p" | grep -q "\"matched_rule\":\"cache.flush\""'
tools 'grep -o "\"matched_rule\":\"[^\"]*\"" /tmp/admin-audit-order-desc.json | sed -n "2p" | grep -q "\"matched_rule\":\"policy.reload\""'
...
tools 'dig +time=2 +tries=1 @pdns-recursor alice.sol TYPE262 | tee /tmp/pdns-alice-sol-type262.txt'
tools 'grep -q "status: NOERROR" /tmp/pdns-alice-sol-type262.txt'

tools 'curl -fsS -X POST http://anyns-plugin-runtime:8081/api/v1/resolve -H "Content-Type: application/json" -d "{\"qname\":\"alice.sol\",\"qtype\":\"WALLET\",\"context\":{\"trace_id\":\"docker-solana-sns-wallet\",\"client_view\":\"default\",\"tenant\":\"default\"}}" | tee /tmp/runtime-alice-sol-wallet.json'
tools 'grep -q "\"source_plugin\":\"solana-sns\"" /tmp/runtime-alice-sol-wallet.json'
tools 'grep -q "\"type\":\"WALLET\"" /tmp/runtime-alice-sol-wallet.json'
tools 'grep -q "sol HKKp49qGWXd639QsuH7JiLijfVW5UtCVY4s1n2HANwEA" /tmp/runtime-alice-sol-wallet.json'
tools 'curl -fsS -H "'"$AUTH_HEADER"'" "http://anyns-plugin-runtime:8081/api/v1/audit/events?trace_id=docker-solana-sns-wallet&source_plugin=solana-sns&rcode=NOERROR&qtype=WALLET" | tee /tmp/runtime-solana-sns-audit.json'
tools 'grep -q "alice.sol" /tmp/runtime-solana-sns-audit.json'
...
tools 'status=$(curl -sS -X POST -o /tmp/runtime-honeypot.json -w "%{http_code}" http://anyns-plugin-runtime:8081/api/v1/resolve -H "Content-Type: application/json" -d "{\"qname\":\"qwertyuiopasdfghjklzxcvbnm1234567890.integration\",\"qtype\":\"TXT\",\"context\":{\"trace_id\":\"docker-honeypot\",\"client_ip\":\"192.0.2.55\",\"client_view\":\"default\",\"tenant\":\"default\"}}"); test "$status" = "404"'
tools 'grep -q "\"action\":\"forward_to_honeypot\"" /tmp/runtime-honeypot.json'
tools 'grep -q "\"source_plugin\":\"router\"" /tmp/runtime-honeypot.json'
tools 'grep -q "\"rcode\":\"NXDOMAIN\"" /tmp/runtime-honeypot.json'
...
tools 'curl -fsS -H "'"$AUTH_HEADER"'" "http://anyns-plugin-runtime:8081/api/v1/audit/events?source_plugin=namecoin-bit&qtype=A&limit=2&order=asc" | tee /tmp/runtime-namecoin-audit-order-asc.json'
tools 'grep -o "\"qname\":\"[^\"]*\"" /tmp/runtime-namecoin-audit-order-asc.json | sed -n "1p" | grep -q "\"qname\":\"example.bit.\""'
tools 'grep -o "\"qname\":\"[^\"]*\"" /tmp/runtime-namecoin-audit-order-asc.json | sed -n "2p" | grep -q "\"qname\":\"www.example.bit.\""'
tools 'curl -fsS -H "'"$AUTH_HEADER"'" "http://anyns-plugin-runtime:8081/api/v1/audit/events?source_plugin=namecoin-bit&qtype=A&limit=2&order=desc" | tee /tmp/runtime-namecoin-audit-order-desc.json'
tools 'grep -o "\"qname\":\"[^\"]*\"" /tmp/runtime-namecoin-audit-order-desc.json | sed -n "1p" | grep -q "\"qname\":\"www.example.bit.\""'
tools 'grep -o "\"qname\":\"[^\"]*\"" /tmp/runtime-namecoin-audit-order-desc.json | sed -n "2p" | grep -q "\"qname\":\"example.bit.\""'
tools 'curl -fsS -H "'"$AUTH_HEADER"'" "http://anyns-plugin-runtime:8081/api/v1/audit/events?source_plugin=namecoin-bit&qtype=A&limit=1&order=asc&page=true" | tee /tmp/runtime-namecoin-audit-page-1.json'
tools 'grep -q "\"next_cursor\":\"1\"" /tmp/runtime-namecoin-audit-page-1.json'
tools 'grep -q "\"qname\":\"example.bit.\"" /tmp/runtime-namecoin-audit-page-1.json'
tools 'curl -fsS -H "'"$AUTH_HEADER"'" "http://anyns-plugin-runtime:8081/api/v1/audit/events?source_plugin=namecoin-bit&qtype=A&limit=1&order=asc&cursor=1" | tee /tmp/runtime-namecoin-audit-page-2.json'
tools 'grep -q "\"qname\":\"www.example.bit.\"" /tmp/runtime-namecoin-audit-page-2.json'
...
tools 'curl -fsS -X POST http://anyns-log-forwarder:8082/api/v1/dns-events -H "Content-Type: application/json" -d "{\"events\":[{\"trace_id\":\"docker-forwarder-event-2\",\"client_ip\":\"192.0.2.58\",\"client_view\":\"default\",\"tenant\":\"default\",\"qname\":\"forwarder-second.integration.test\",\"qtype\":\"TXT\",\"rcode\":\"NOERROR\",\"source_plugin\":\"security\",\"risk_level\":\"high\",\"action\":\"forward_to_honeypot\",\"matched_rule\":\"docker-forwarder-fixture\",\"latency_ms\":9}]}" | tee /tmp/log-forwarder-post-2.json'
tools 'grep -q "\"accepted\":1" /tmp/log-forwarder-post-2.json'
tools 'curl -fsS -H "'"$AUTH_HEADER"'" "http://anyns-log-forwarder:8082/api/v1/audit/events?source_plugin=security&matched_rule=docker-forwarder-fixture&limit=2&order=asc" | tee /tmp/log-forwarder-audit-order-asc.json'
tools 'grep -o "\"qname\":\"[^\"]*\"" /tmp/log-forwarder-audit-order-asc.json | sed -n "1p" | grep -q "\"qname\":\"forwarder.integration.test\""'
tools 'grep -o "\"qname\":\"[^\"]*\"" /tmp/log-forwarder-audit-order-asc.json | sed -n "2p" | grep -q "\"qname\":\"forwarder-second.integration.test\""'
...
tools 'curl -fsS -H "'"$AUTH_HEADER"'" "http://anyns-log-forwarder:8082/api/v1/audit/events?source_plugin=security&matched_rule=docker-forwarder-fixture&limit=1&order=asc&page=true" | tee /tmp/log-forwarder-audit-page-1.json'
tools 'grep -q "\"next_cursor\":\"1\"" /tmp/log-forwarder-audit-page-1.json'
tools 'grep -q "\"qname\":\"forwarder.integration.test\"" /tmp/log-forwarder-audit-page-1.json'
tools 'curl -fsS -H "'"$AUTH_HEADER"'" "http://anyns-log-forwarder:8082/api/v1/audit/events?source_plugin=security&matched_rule=docker-forwarder-fixture&limit=1&order=asc&cursor=1" | tee /tmp/log-forwarder-audit-page-2.json'
tools 'grep -q "\"qname\":\"forwarder-second.integration.test\"" /tmp/log-forwarder-audit-page-2.json'
